			...
			public static void main(String[] args) {
				// TODO Auto-generated method stub
				   ...
				   // Main method
				         ...
				         String binaryString=JOptionPane.showInputDialog("Enter a 8-bit binary number");
				...
				/*      				
				         ...
				         binary=binary/10;//get rid of the 8th bit, now the 5th bit is last
				         
				         bit=binary%10;//get the last bit (7th)
				         decimal=decimal+bit*1;//add it, multiplied by the corresponding power of 2
				         binary=binary/10;//get rid of the 7th bit, now the 5th bit is last
